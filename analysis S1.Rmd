...
```{r}
write_rds(lm_PPT_coef,"lm_PPT_coef.rds")
write_rds(lm_NPP_coef,"lm_NPP_coef.rds")
write_rds(lm_TEMP_coef,"lm_TEMP_coef.rds")

write_rds(lm_PPT_aic,"lm_PPT_aic.rds")
write_rds(lm_NPP_aic,"lm_NPP_aic.rds")
write_rds(lm_TEMP_aic,"lm_TEMP_rsquared.rds")

write_rds(lm_PPT_rsquared,"lm_PPT_rsquared.rds")
write_rds(lm_NPP_rsquared,"lm_NPP_rsquared.rds")
write_rds(lm_TEMP_rsquared,"lm_TEMP_rsquared.rds")
```
