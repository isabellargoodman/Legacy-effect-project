...
write_csv(COLDdata,"COLDdata.csv")
...
npp_ppt_data<-subset(npp_ppt_data, select=-c("pue","PUEsd","minPUE","maxPUE","meanPUE"))

saveRDS(npp_ppt_data,file="npp_ppt_data.rds",compress=TRUE)
...
NSdata<-npp_ppt_data[npp_ppt_data$ecoregion=='ns',]
