...
```{r}
write_rds(lm_map_coef, "lm_map_coef1.rds")
write_rds(lm_currentPPT_coef, "lm_currentPPT_coef1.rds")
write_rds(lm_herb_coef, "lm_herb_coef1.rds")

write_rds(lm_map_aic, "lm_herb_ai1c.rds")
write_rds(lm_currentPPT_aic, "lm_currentPPT_aic1.rds")
write_rds(lm_herb_aic, "lm_herb_aic1.rds")

write_rds(lm_map_rsquared, "lm_map_rsquared1.rds")
write_rds(lm_currentPPT_rsquared, "lm_currentPPT_rsquared1.rds")
write_rds(lm_herb_rsquared, "lm_herb_rsquared1.rds")
...
#create figure 3b
effect_byEco<-ggplot()+
  geom_density(data=map_coefficients, aes(x=Temporal, fill=ecoregion, after_stat(scaled)), alpha=.4)+
  scale_fill_manual(values=c("indianred","skyblue","darkorchid","darkolivegreen3","gold"),
