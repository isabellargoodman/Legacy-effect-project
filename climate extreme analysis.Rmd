...
cali_ecoregion$leadNPP<-as.numeric(lead(cali_ecoregion$NPP, 35799))
cali_ecoregion$leadPPT<-as.numeric(lead(cali_ecoregion$PPT, 35799))
...
cold_ecoregion$leadNPP<-as.numeric(lead(cold_ecoregion$NPP, 324070))
cold_ecoregion$leadPPT<-as.numeric(lead(cold_ecoregion$PPT, 324070))
cold_ecoregion<-cold_ecoregion%>%
  drop_na()

northern_ecoregion<-legacydata[legacydata$ecoregion=='northern',]
northern_ecoregion$leadNPP<-as.numeric(lead(northern_ecoregion$NPP, 312166))
northern_ecoregion$leadPPT<-as.numeric(lead(northern_ecoregion$PPT, 312166))
northern_ecoregion<-northern_ecoregion%>%
  drop_na()

sgs_ecoregion<-legacydata[legacydata$ecoregion=="sgs",]
sgs_ecoregion$leadNPP<-as.numeric(lead(sgs_ecoregion$NPP, 122178))
sgs_ecoregion$leadPPT<-as.numeric(lead(sgs_ecoregion$PPT, 122178))
sgs_ecoregion<-sgs_ecoregion%>%
  drop_na()

hot_ecoregion<-legacydata[legacydata$ecoregion=='hot',]
hot_ecoregion$leadNPP<-as.numeric(lead(hot_ecoregion$NPP, 143425))
hot_ecoregion$leadPPT<-as.numeric(lead(hot_ecoregion$PPT, 143425))
...
write_rds(highprod_data_maxs, "highprod_data_max.rds")
...
highprod_data_maxs<-readRDS("highprod_data_max.rds")
